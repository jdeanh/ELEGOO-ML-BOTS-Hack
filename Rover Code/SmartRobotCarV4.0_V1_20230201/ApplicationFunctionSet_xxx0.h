...
public:
  ...
  void ApplicationFunctionSet_Viper(void); //JH - Added viper mode
...
public: /*CMD*/
  ...
  void CMD_CarControlTimeLimit_Viper_xxx0(void); //JH - Added viper mode
...
public:
  ...
  const float VoltageDetection = 4.500; //JH - changed from 7.00 to 4.50
